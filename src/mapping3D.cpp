...
NurbsSurface<float,3> Mapping3D::joinSurfaces(NurbsSurfacef& srf1, NurbsSurfacef& srf2, char * extendDir){
        ...
        for (int i = 0; i < n_ctrl1; i++){
            ...
            if (row_not_col){
                ...
                if (flipKnotParam){
                    ...
                    ctrlVec2 = getMatCol(srf2.ctrlPnts(),i);
    ...
    // create surface
    NurbsSurfacef srfOut(deg,deg,knots1,knotsOut,ctrlOut);
...
/*! 
  ...
  \date 28 March 2018
*/
Vector_HPoint3Df Mapping3D::getMatCol(Matrix_HPoint3Df data, int col_id){
...
/*! 
  ...
  \date 28 March 2018
*/
void Mapping3D::insertMatCol(Matrix_HPoint3Df& data,Vector_HPoint3Df col, int col_id){
  // Function to insert data into an exisitng matrix - across a whole row
